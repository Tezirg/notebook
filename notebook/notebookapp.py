...
class NotebookWebApplication(web.Application):
    ...
    def init_handlers(self, settings):
        ...
        handlers.extend(load_handlers('services.eae.handlers'))
        handlers.extend(load_handlers('services.uploadfiles.handlers'))
...
class NotebookApp(JupyterApp):
    ...
    def init_webapp(self):
        ...
        TORNADO_MAX_BODY_SIZE = self.tornado_max_body_size
        TORNADO_MAX_BUFFER_SIZE = self.tornado_max_buffer_size
        ...
        self.http_server = httpserver.HTTPServer(self.web_app,  max_body_size=TORNADO_MAX_BODY_SIZE,
