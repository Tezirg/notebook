...
import {ShortcutEditor} from 'notebook/js/shortcuteditor';
	...
	Notebook.prototype.eae_submit = function() {
		...
		var main_select = $("<select class='form-control row' id='eae-submit-main-items' name='eae-submit-main-items'></select>");
		...
		var cluster_field = $("<div id='eae-submit-cluster-field' class='form-group row'>" +
							  ...
							  "</div>");
		var cluster_select = $("<select id='eae-submit-cluster-items' name='eae-submit-cluster-items' class='form-control row'></select>");
